...
print("Alice rates movie 101:", response.json())
time.sleep(0.5)
...
print("Bob rates movie 101:", response.json())
time.sleep(0.5)
...
print("Bob rates movie 102:", response.json())
time.sleep(0.5)
...
print("Carol rates movie 103:", response.json())
time.sleep(0.5)
...
print("Carol rates movie 104:", response.json())
time.sleep(1)
...
print("Bob agrees with Alice's rating:", response.json())
time.sleep(0.5)
...
print("Carol disagrees with Bob's rating:", response.json())
time.sleep(1)
...
# Friends watched Recommendations
